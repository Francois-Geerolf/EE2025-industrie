...
graphique3_data <- NV.IND.MANF.CD %>%
...
write_csv2(graphique3_data, file = "graphiques/graphique3.csv")

graphique3 <- graphique3_data %>%
...
graphique3
save(graphique3, file = "graphiques/graphique3.RData")
ggsave(graphique3, file = "graphiques/graphique3.pdf", bg = "white", width = 7, height = 4)
ggsave(graphique3, file = "graphiques/graphique3.png", bg = "white", width = 7, height = 4)
ggsave(graphique3, file = "graphiques/graphique3.svg", bg = "white", width = 7, height = 4)
